...
class CoreRoutingTest extends BaseService
{
    ...
    public function testRestNoAcceptHeader()
    {
        ...
        $response = $curlClient->get('/V1/testmodule1/resource1/1', [], ['AcceptPrivacy:']);
        $this->assertEquals('testProduct1', $response['name'], "Empty AcceptPrivacy header failed to return response.");
    }
